                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text("${regionMap[post.regionId]} · ${post.categoryNames == 1 ? indoorHobbies[post.subCategory] : outdoorHobbies[post.subCategory]}", style: const TextStyle(color: Colors.grey)),
                          ],
                        ),
                      ],
                    ),
